...
function Model({ url }: ModelProps) {
  ...
  return <primitive ref={ref} object={scene} scale={[15, 15, 15]} position={[0, 0, 0]} />;
}

// Es necesario pre-cargar el modelo para evitar el problema de carga inicial
useGLTF.preload('/3D/Semillas/Semilla_1/semilla.gltf');

export default function Semilla3D() {
  ...
  return (
    <Canvas
      ref={canvasRef}
      style={{ width: 'auto', height: '600px', maxHeight: '600px', cursor: 'grab'}}
    ...
    >
      ...
      <Suspense fallback={null}>
        <Model url="/3D/Semillas/Semilla_1/semilla.gltf" />
      </Suspense>
